...
// ── Helpers ────────────────────────────────────────────────────────────────
const CAT_ES = {
  // Security (exact names from Cloudflare)
  'Blocked by Default':           'Bloqueado por defecto',
  ...
  // Content (exact names from Cloudflare)
  'Ads':                          'Publicidad',
  'Business & Economy':           'Empresa y economía',
  'CIPA':                         'CIPA',
  'Deceptive Ads':                'Publicidad engañosa',
  'Education':                    'Educación',
  ...
  'Internet Communication':       'Comunicación en internet',
  'Job Search & Careers':         'Trabajo y empleo',
  'Military & Weapons':           'Militar y armas',
  'Miscellaneous':                'Varios',
  'No Content':                   'Sin contenido',
  'Questionable Content':         'Contenido cuestionable',
  'Real Estate':                  'Inmobiliaria',
  'Religion':                     'Religión',
  'Safe for Kids':                'Apto para niños',
  'Shopping & Auctions':          'Compras y subastas',
  'Social & Family':              'Social y familia',
  'Society & Lifestyle':          'Sociedad y estilo de vida',
  'Sports':                       'Deportes',
